...
SELECT * INTO eldb_cp7.cp7_features_renamed FROM eldb_cp7.cp7_optimized_feature_facts;

\echo '--alter tables to add a new column to each with default value'

ALTER TABLE eldb_cp7.cp7_features_renamed ADD column_renamed text;
update eldb_cp7.cp7_features_renamed set column_renamed = 'NoRename';
...
\echo 'Update cp7'     
        update eldb_cp7.cp7_features_renamed nf
...
delete from eldb_cp7.cp7_features_renamed where column_renamed = 'NoRename';
