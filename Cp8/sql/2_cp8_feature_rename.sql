...
\echo '--create feature_renamed tables for all versions'

SELECT * INTO eldb_cp8.cp8_features_renamed FROM eldb_cp8.cp8_optimized_feature_facts;

\echo '--alter tables to add a new column to each with default value'

ALTER TABLE eldb_cp8.cp8_features_renamed ADD column_renamed text;
update eldb_cp8.cp8_features_renamed set column_renamed = 'NoRename';
...
\echo 'Update cp8'     
        update eldb_cp8.cp8_features_renamed nf
...
delete from eldb_cp8.cp8_features_renamed where column_renamed = 'NoRename';
